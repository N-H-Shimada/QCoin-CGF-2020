# QCoin-CGF-2020
This repository contains sample codes used in the paper: "Quantum Coin Method for Numerical Integration" (pulished in [Computer Graphics Forum](), manuscript is also available in [arXiv](https://arxiv.org/abs/1910.00263)).
